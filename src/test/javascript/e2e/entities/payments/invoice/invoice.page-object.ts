...
export class InvoiceDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('erpSystemR22App.paymentsInvoice.delete.question'));
...
export default class InvoiceComponentsPage {
  ...
  async deleteInvoice() {
    ...
    expect(await invoiceDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/erpSystemR22App.paymentsInvoice.delete.question/);
