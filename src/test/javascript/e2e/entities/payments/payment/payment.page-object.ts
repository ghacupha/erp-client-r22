...
export class PaymentDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('erpSystemR22App.paymentsPayment.delete.question'));
...
export default class PaymentComponentsPage {
  ...
  async deletePayment() {
    ...
    expect(await paymentDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/erpSystemR22App.paymentsPayment.delete.question/);
