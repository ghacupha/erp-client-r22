...
export class PurchaseOrderDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('erpSystemR22App.purchaseOrder.delete.question'));
...
export default class PurchaseOrderComponentsPage {
  ...
  async deletePurchaseOrder() {
    ...
    expect(await purchaseOrderDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/erpSystemR22App.purchaseOrder.delete.question/);
