...
export default class XlsxReportRequisitionUpdatePage {
  pageTitle: ElementFinder = element(by.id('erpSystemR22App.xlsxReportRequisition.home.createOrEditLabel'));
  saveButton: ElementFinder = element(by.id('save-entity'));
  cancelButton: ElementFinder = element(by.id('cancel-save'));
  reportNameInput: ElementFinder = element(by.css('input#xlsx-report-requisition-reportName'));
  reportDateInput: ElementFinder = element(by.css('input#xlsx-report-requisition-reportDate'));
  userPasswordInput: ElementFinder = element(by.css('input#xlsx-report-requisition-userPassword'));
  reportFileChecksumInput: ElementFinder = element(by.css('input#xlsx-report-requisition-reportFileChecksum'));
  reportStatusSelect: ElementFinder = element(by.css('select#xlsx-report-requisition-reportStatus'));
  reportIdInput: ElementFinder = element(by.css('input#xlsx-report-requisition-reportId'));
  reportTemplateSelect: ElementFinder = element(by.css('select#xlsx-report-requisition-reportTemplate'));
  placeholderSelect: ElementFinder = element(by.css('select#xlsx-report-requisition-placeholder'));
  parametersSelect: ElementFinder = element(by.css('select#xlsx-report-requisition-parameters'));
